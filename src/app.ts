...
import platform = require('./components2/platform');
import updater = require('./components2/updater');
import menus = require('./components2/menus');
import settings = require('./components2/settings');
import windowBehaviour = require('./components2/window-behavior');
import dispatcher = require('./components2/dispatcher');
